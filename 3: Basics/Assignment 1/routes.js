...
const requestHandler = (req, res) => {
	...
	if (url === "/") {
		res.write(
			'<html><head><title>Enter Message</title></head><body><h1>Hello World!</h1><form action="/message" method="POST"><input type="text" name="message"><button type="submit">Send</button></form></h1></body></html>'
		);
		return res.end();
	}
